python main.py --model EDSR --scale 4 --patch_size 192 \
  ...
  --pre_train "/workspace/EDSR-Lite/experiment/edsr_baseline_x4_ptq/model/model_ptq_quantized.pt" \
  --test_only --save_results --cpu --save edsr_baseline_x4_ptq_demo
...
sr_dir = Path("/workspace/EDSR-Lite/experiment/edsr_baseline_x4_ptq_demo/results-Demo")
