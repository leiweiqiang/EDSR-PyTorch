python main.py --model EDSR --scale 4 --patch_size 192 \
  ...
  --pre_train "/workspace/EDSR-Lite/experiment/edsr_baseline_x4_ptq_int4/model/model_ptq.pt" \
  --quantize ptq_int4 \
  --test_only --save_results --cpu --save edsr_baseline_x4_ptq_int4_demo
...
sr_dir = Path("/workspace/EDSR-Lite/experiment/edsr_baseline_x4_ptq_int4_demo/results-Demo")
